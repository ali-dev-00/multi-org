...
export default function Authenticated({
    ...
    const currentOrgId = (page.props as any).currentOrganizationId as number | null;
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                {currentOrgId ? (
                                    <span className="inline-flex items-center text-xs text-gray-500">Org: {currentOrgId}</span>
                                ) : null}
                            </div>
                        </div>
